package com.retailers.sbj.common.util;
...
public class HttpClientManager {
	...
	//需要使用代理的服务器:web网站服务器
	private static String MUST_PROXY_HOST = "10.172.72.201";
	//代理host
	public static String PROXY_HOST = "10.172.73.135";
	//代理端口
	public static int PROXY_PORT = 809;
	...
	public static CloseableHttpClient getHttpClient() {
		return HttpClients.custom().setConnectionManager(connMgr).setKeepAliveStrategy(kaStrategy).build();
	}
