...
<script type="text/javascript">
    ...
    var treeColumns=[
        ...
        },
        {
            ...
            title: '详情',
            formatter:function (value,row,index) {
                rowDatas.set(row.emcId,row);
                let html='';
                html+='<button class="btn btn-primary" onclick="event.stopPropagation();editFloor('+row.emcId+')">详情</button>'
                return html;
            }
        }
    ]
    ...
    $(function () {
        createTable("/EmployeeManageCopy/queryEmployeeManageCopyList","goodsTypeTables","fmId",treeColumns,queryParams)
    });
    /**
     * 查询条件
     **/
