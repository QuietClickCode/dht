...
import com.retailers.auth.annotation.SystemServiceLog;
...
//	private LogService logService;
	...
	// Service层切点
	@Pointcut("@annotation(com.retailers.auth.annotation.SystemServiceLog)")
	public void serviceAspect() {
	}

	// Controller层切点
	@Pointcut("@annotation(com.retailers.auth.annotation.SystemControllerLog)")
...
//			logService.add(log);
	...
	public void s(JoinPoint joinPoint) {
		System.out.println("serviceAspect-----zp------------->:");
	}
