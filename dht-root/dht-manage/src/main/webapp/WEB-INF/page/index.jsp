                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li class="m-t-xs">
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="main/img/a7.jpg">
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="main/img/a4.jpg">
                                    </a>
                                    <div class="media-body ">
                            ...
                            <li>
                                <div class="text-center link-block">
                                    <a class="menu_item" href="mailbox.html">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-alerts">
                            ...
                            <li>
                                <div class="text-center link-block">
                                    <a class="menu_item" href="notifications.html">
                                        <strong>查看所有 </strong>
                    ...
                    <li class="hidden-xs">
                        <a href="index_v1.html" class="menu_item" data-index="0"><i class="fa fa-cart-arrow-down"></i> 购买</a>
                    </li>
                ...
                <div id="tab-2" class="tab-pane">
                    ...
                    <div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="main/img/a1.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="main/img/a2.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="main/img/a3.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="main/img/a4.jpg">
                                </div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="main/img/a8.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="main/img/a7.jpg">
                                </div>
                                <div class="media-body">
...
<script type="text/javascript">
    ...
    function itemMenu(obj,node){
        let curNode = node;
        let html ='<li level="'+curNode+'">';
        let url=obj.url;
        let aClass="menu_item";
        //是否有子节点
        let isChild=false;
        let childs=obj.child;
        if(childs.length>0){
            isChild=true;
        }
        if(!obj.url){
        ...
        html+='<a href="'+url+'" class="'+aClass+'" style="padding:14px 20px 14px '+((curNode)*10+25)+'px;">';
        html+='<i class="fa '+menuIcon+'"></i>';
        if(isChild){
            /*';*/
            html+='<span class="nav-label">'+obj.label+'</span>';
...
//            html+='<ul class="nav menu_node_child">';
            html+='<ul class="nav menu_node_child">';
            for(var i =0;i<childs.length;i++){
                html+=itemMenu(childs[i],curNode+1);
            }
            html+='</ul>';
        }
        html+="</li>";
