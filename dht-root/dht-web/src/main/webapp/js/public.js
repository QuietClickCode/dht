...
$(".J_allCheckbox").click(function() {
    $(this).toggleClass("active"),
        checkboxState ? ($(".J_checkbox").addClass("active"), checkboxState = !1) : ($(".J_checkbox").removeClass("active"), checkboxState = !0),
        total()
});
var totalNum = parseFloat($("#J_totalNum").text());
$(".J_checkbox").on("click",
    function() {
        $(this).parents(".J_careCheckbox").find(".J_checkbox").removeClass("active"),
